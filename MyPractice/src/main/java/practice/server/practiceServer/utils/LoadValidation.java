...
public class LoadValidation {
    public static void validation(LoadEntity entity) {
        ...
        if (entity.getDiplomaHours() < 0) {
            throw new LoadExceptionValidation("Данные за диплом должны быть заполнены");
        }
        ...
        if (entity.getExamHours() < 0) {
            throw new LoadExceptionValidation("Данные за экзамен должны быть заполнены");
        }
